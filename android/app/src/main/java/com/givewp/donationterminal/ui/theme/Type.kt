package com.givewp.donationterminal.ui.theme
...
val Typography = Typography(
    displayLarge = TextStyle(fontFamily = FontFamily.Default, fontSize = 57.sp),
    headlineMedium = TextStyle(fontFamily = FontFamily.Default, fontSize = 28.sp),
